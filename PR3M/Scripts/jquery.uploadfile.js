...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var uploadLabel = $('<div><i class="fa fa-upload" aria-hidden="true"></i>' + s.uploadStr + '</div>');
        ...
        (function checkAjaxFormLoaded() {
            if ($.fn.ajaxForm) {
                ...
                if (s.dragDrop) {
                    var dragDrop = $('<div class="' + s.dragDropContainerClass + '"></div>').width(s.dragdropWidth);
                    $(obj).append(dragDrop);
        ...
        function createCustomInputFile(obj, group, s, uploadLabel) {
            ...
            var fileInputStr = "<input type='file' id='" + fileUploadId + "' name='" + s.fileName + "' accept='" + s.acceptFiles + "' webkitdirectory mozdirectory/>";
            if (s.multiple) {
                if (s.fileName.indexOf("[]") != s.fileName.length - 2) // if it does not endwith
                {
                    s.fileName += "[]";
                }
                fileInputStr = "<input type='file' id='" + fileUploadId + "' name='" + s.fileName + "' accept='" + s.acceptFiles + "' webkitdirectory mozdirectory multiple />";
            }
